<div class="cr-coursesdetails">
                    ...
                    <div class="cr-sidebar_accordion_item accordion-item">
                        <div class="cr-sidebar_accordion_title" id="cr-heading{{ $key }}">
                            <a href="javascript:void(0);" data-bs-toggle="collapse"
                                ...
                                aria-controls="cr-collapse{{ $key }}" @class([
                                    'collapsed' =>
                                        !empty($activeCurriculum['section_id']) &&
                                        $activeCurriculum['section_id'] != $section->id,
                                ])>
                                <em>{{ $key + 1 }}.</em>
                        ...
                        @if ($section->curriculums->count() > 0)
                            <div @class([
                                ...
                                aria-labelledby="cr-heading{{ $key }}" data-bs-parent="#cr-sidebar_accordion">
                                @foreach ($section->curriculums as $curriculum)
                                    <div class="cr-sidebar_accordion_content_item">
                                        <a href="javascript:void(0);" id="cr-curriculum-{{ $counter }}"
                                            @class([
                                                'cr-active' =>
                                                    !empty($activeCurriculum['id']) &&
                                                    $activeCurriculum['id'] == $curriculum['id'],
                                            ])
                                            @if (!empty($activeCurriculum['id']) && $activeCurriculum['id'] != $curriculum['id']) wire:click.prevent="setActiveCurriculum({{ $curriculum }})" @endif>
                                            <span>
                ...
                <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#cr-sharemodal" class="cr-btn">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18"
                        ...
                        <g opacity="0.6" clip-path="url(#clip0_13156_65705)">
                            <path
                                d="M8.25 9.75L8.53457 10.4899C9.5894 13.2326 10.1168 14.6039 10.825 14.9489C11.4376 15.2472 12.1598 15.2132 12.7416 14.8586C13.4143 14.4486 13.8104 13.0338 14.6028 10.2041L15.716 6.22824C16.2177 4.43672 16.4685 3.54096 16.2357 2.92628C16.0327 2.39035 15.6096 1.96724 15.0737 1.76427C14.459 1.53147 13.5633 1.78228 11.7717 2.28391L7.79584 3.39716C4.96617 4.18947 3.55133 4.58563 3.14136 5.25828C2.78678 5.84005 2.75275 6.56231 3.05106 7.17484C3.39597 7.88306 4.76729 8.41049 7.50992 9.46536L8.25 9.75ZM8.25 9.75L10.125 7.875"
        ...
        <div class="cr-coursedetails_body">
                ...
                @if (!empty($activeCurriculum))
                    ...
                    @if (!empty($nextItem))
                        <div class="cr-next-curriculum d-none">
                            <div class="cr-next-curriculum_content">
                                ...
                                <button class="cr-next-curriculum_btn"
                                    wire:click.prevent="nextCurriculum({{ $nextItem['id'] }})">
                        ...
                        $nextTick(() => {
                            ...
                            <strong class="am-logo">
                                @if (!empty(setting('_general.watermark_logo')))
                                    <img src="{{ url(Storage::url(setting('_general.watermark_logo')[0]['path'])) }}"
                                        alt="watermark-logo">
                                @else
                                    <img src="{{ asset('modules/courses/images/green-logo.png') }}"
                                        alt="watermark-logo">
                                @endif
                            </strong>
                            <div class="cr-video-info">
                                <figure>
                                    @if (
                                        !empty($course?->instructor?->profile?->image) &&
                                            Storage::disk(getStorageDisk())->exists($course?->instructor?->profile?->image))
                                        <img src="{{ resizedImage($course?->instructor?->profile?->image, 50, 50) }}"
                                            alt="{{ $course?->instructor?->profile?->image }}" />
                                    @else
                                        <img src="{{ setting('_general.default_avatar_for_user') ? url(Storage::url(setting('_general.default_avatar_for_user')[0]['path'])) : resizedImage('placeholder.png', 50, 50) }}"
                                            alt="{{ $course?->instructor?->profile?->image }}" />
                                    @endif
                                </figure>
                    ...
                    @elseif($activeCurriculum['type'] == 'yt_link')
                        ...
                        <div x-data="{
                            ...
                            <iframe id="yt-video-{{ $activeCurriculum['id'] }}"
                                src="https://www.youtube.com/embed/{{ $yt_id }}?enablejsapi=1" frameborder="0"
                    ...
                    @elseif($activeCurriculum['type'] == 'vm_link')
                        ...
                        <div x-data="{
                            ...
                            <iframe id="vm-video-{{ $activeCurriculum['id'] }}" class="am-iframe-video"
                                src="https://player.vimeo.com/video/{{ $videoId }}?api=1&player_id=vm-video-{{ $activeCurriculum['id'] }}"
                                frameborder="0" x-on:load="onVimeoIframeAPIReady('{{ $activeCurriculum['id'] }}')"
                                allowfullscreen
                        ...
                        @if (auth()->user()->role == 'student')
                            <div id="article-{{ $activeCurriculum['id'] }}" class="cr-coursedetails_article">
                                ...
                                <div class="cr-coursedetails_article_actions">
                                    @if (isset($activeCurriculum['watchtime']['duration']) &&
                                        ...
                                        @if (!empty($curriculumOrder[$activeCurriculum['id']]))
                                            <a href="javascript:void(0);" class="am-btn"
                                                wire:click.prevent="nextCurriculum({{ $curriculumOrder[$activeCurriculum['id']] }})">Go
                                                to next item</a>
                                        @endif
                                        <button type="button" class="am-btnnext"><svg
                                                xmlns="http://www.w3.org/2000/svg" width="17" height="16"
                                                viewBox="0 0 17 16" fill="none">
                                                <path d="M3.16699 8.66667L6.50033 12L13.8337 4" stroke="#34A853"
                                                    stroke-width="2.25" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg> Completed</button>
                                    @else
                                        <button type="button" class="am-btn"
                                            wire:click.prevent="markAsCompleted()">Mark as complete</button>
                                    @endif
                                </div>
                ...
                @else
                    <div wire:ignore class="cr-image-wrapper" x-data="{
                        ...
                        <template x-if="isPlaying">
                            <video class="video-js" data-setup='{"autoplay": true}' onloadeddata="videojs(this)"
                                preload="auto" id="promotional-video" width="320" height="240" controls>
                            ...
                            <figure class="cr-image-wrapper">
                                @if (!empty($course->thumbnail?->path) && Storage::disk(getStorageDisk())->exists($course->thumbnail?->path))
                                    <img src="{{ Storage::url($course->thumbnail->path) }}"
                                        alt="{{ $course->title }}" class="cr-background-image" />
                                @else
                                    <img src="{{ asset('modules/courses/images/course.png') }}"
                                        alt="{{ $course->title }}" />
                                @endif

                                @if (
                                    !empty($course?->promotionalVideo?->path) &&
                                        Storage::disk(getStorageDisk())->exists($course?->promotionalVideo?->path))
            ...
            <div class="cr-coursecontent">
                <div class="cr-coursecontent_body" x-data="{ activeTab: 'cr-overview' }">
                    <ul wire:ignore class="cr-coursecontent_tabs nav nav-tabs" id="cr-coursecontenttab"
                        role="tablist">
                        <li class="nav-item cr-coursecontent_tab" :class="{ 'active': activeTab === 'cr-overview' }"
                            role="cr-coursecontent_tab">
                            <button class="nav-link" @click="activeTab = 'cr-overview'" id="cr-overview-tab"
                                data-bs-toggle="tab" data-bs-target="#cr-overview" type="button" role="tab"
                                aria-controls="cr-overview"
                                aria-selected="true">{{ __('courses::courses.overview') }}</button>
                        </li>
                        <li class="nav-item cr-coursecontent_tab" :class="{ 'active': activeTab === 'cr-faq' }"
                            role="cr-coursecontent_tab">
                            <button class="nav-link" @click="activeTab = 'cr-faq'" id="cr-faq-tab"
                                data-bs-toggle="tab" data-bs-target="#cr-faq" type="button" role="tab"
                                aria-controls="cr-faq"
                                aria-selected="false">{{ __('courses::courses.prerequisites_and_faqs') }}</button>
                        </li>
                        @if (
                            \Nwidart\Modules\Facades\Module::has('forumwise') &&
                                \Nwidart\Modules\Facades\Module::isEnabled('forumwise') &&
                                !empty($course->discussion_forum))
                            <li class="nav-item cr-coursecontent_tab"
                                :class="{ 'active': activeTab === 'cr-discussion' }" role="cr-coursecontent_tab">
                                <button class="nav-link" @click="activeTab = 'cr-discussion'" id="cr-discussion-tab"
                                    data-bs-toggle="tab" data-bs-target="#cr-discussion" type="button"
                                    role="tab" aria-controls="cr-discussion"
                                    aria-selected="false">{{ __('courses::courses.discussion_forum') }}</button>
                            </li>
                        @endif
                        <li class="nav-item cr-coursecontent_tab"
                            :class="{ 'active': activeTab === 'cr-noticeboard' }" role="cr-coursecontent_tab">
                            <button class="nav-link" @click="activeTab = 'cr-noticeboard'" id="cr-noticeboard-tab"
                                data-bs-toggle="tab" data-bs-target="#cr-noticeboard" type="button" role="tab"
                                aria-controls="cr-noticeboard"
                                aria-selected="false">{{ __('courses::courses.noticeboard') }}</button>
                        </li>
                    </ul>
                    <div class="cr-coursecontent_tabs_content tab-content" id="cr-tab-content" wire:ignore.self>
                        <div wire:ignore.self class="tab-pane fade active"
                            x-bind:class="{ 'show active': activeTab === 'cr-overview' }" id="cr-overview"
                            role="tabpanel" aria-labelledby="cr-overview-tab">
                                    ...
                                    <div class="cr-course-details-info">
                                        @if (!empty($course->title) || !empty($course->subtitle))
                                            <div class="am-searchhead_title">
                                                <div class="cr-title-box">
                                                    ...
                                                    <span><em>{{ __('courses::courses.in') }}:</em>
                                        ...
                                        <div class="cr-course-meta">
                                            <div class="cr-rating-container">
                                                <span @class([
                                                    'cr-stars',
                                                    'cr-' . floor($course->ratings_avg_rating) . 'star' => !empty(
                                                ...
                                                <span
                                                    class="cr-rating-score">{{ number_format($course->ratings_avg_rating, 1) }}</span>
                                                <span class="cr-review-count">({{ $course->ratings_count }}
                                                    {{ __('courses::courses.reviews') }})</span>
                                            </div>
                                            ...
                                            @if (!empty($course->updated_at))
                                                <div class="cr-last-updated">
                                                    ...
                                                    <span
                                                        class="cr-update-date">{{ __('courses::courses.last_updated') }}:
                                                        {{ \Carbon\Carbon::parse($course->updated_at)->format('M d, Y') }}</span>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="cr-course-stats">
                                            @if (!empty($course->level))
                                                <div class="cr-stat-item">
                                                    ...
                                                    <div class="cr-stat-content">
                                                        <span
                                                            class="cr-stat-label">{{ __('courses::courses.level') }}</span>
                                                        <span
                                                            class="cr-stat-value">{{ __('courses::courses.' . $course->level) }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                                ...
                                                <div class="cr-stat-item">
                                                    <div class="cr-stat-icon-wrapper">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="15"
                                                            ...
                                                            <path opacity="0.7"
                                                                d="M13.75 8C13.75 11.4518 10.9518 14.25 7.5 14.25M13.75 8C13.75 4.54822 10.9518 1.75 7.5 1.75M13.75 8C13.75 6.61929 10.9518 5.5 7.5 5.5C4.04822 5.5 1.25 6.61929 1.25 8M13.75 8C13.75 9.38071 10.9518 10.5 7.5 10.5C4.04822 10.5 1.25 9.38071 1.25 8M7.5 14.25C4.04822 14.25 1.25 11.4518 1.25 8M7.5 14.25C8.88071 14.25 10 11.4518 10 8C10 4.54822 8.88071 1.75 7.5 1.75M7.5 14.25C6.11929 14.25 5 11.4518 5 8C5 4.54822 6.11929 1.75 7.5 1.75M1.25 8C1.25 4.54822 4.04822 1.75 7.5 1.75"
                                                                stroke="#585858" stroke-width="1.25"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                    </div>
                                                    <div class="cr-stat-content">
                                                        <span
                                                            class="cr-stat-label">{{ __('courses::courses.language') }}</span>
                                                        <span
                                                            class="cr-stat-value">{{ $course->language?->name }}</span>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="cr-stat-item">
                                                ...
                                                <div class="cr-stat-content">
                                                    <span
                                                        class="cr-stat-label">{{ __('courses::courses.enrolments') }}</span>
                                                    <span
                                                        class="cr-stat-value">{{ number_format($course?->enrollments_count ?? 0) }}
                                                        {{ $course?->enrollments_count == 1 ? __('courses::courses.student') : __('courses::courses.students') }}</span>
                                                </div>
                                            </div>
                                            <div class="cr-stat-item">
                                                <div class="cr-stat-icon-wrapper">
                                                ...
                                                <div class="cr-stat-content">
                                                    <span
                                                        class="cr-stat-label">{{ __('courses::courses.views') }}</span>
                                                    <span
                                                        class="cr-stat-value">{{ number_format($course->views_count) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            @if (!empty($course->validity) && !empty($course->validity_type))
                                                <div class="cr-stat-item">
                                                    ...
                                                    <div class="cr-stat-content">
                                                        <span
                                                            class="cr-stat-label">{{ __('courses::courses.course_validity_period') }}</span>
                                                        <span class="cr-stat-value">{{ $course->validity }}
                                                            {{ Str::ucfirst($course->validity_type) }}</span>
                                                    </div>
                                                </div>
                                            @endif
                            ...
                            @if (!empty($course->description))
                                <div class="cr-overview-course cr-desc-section"
                                    x-bind:class="{ 'cr-desc-section-show': showMore }" id="overview"
                                    x-data="{
                                        showMore: false,
                                        get textValue() {
                                    ...
                                    @if (strlen(strip_tags($course->description)) > 220)
                                        <a href="javascript:void(0);" class="cr-show" @click="showMore = !showMore"
                                            x-text="textValue">
                                        </a>
                                    @endif
                                </div>
                        ...
                        <div wire:ignore.self class="tab-pane fade"
                            x-bind:class="{ 'show active': activeTab === 'cr-faq' }" id="cr-faq" role="tabpanel"
                            aria-labelledby="cr-faq-tab">
                                                ...
                                                @foreach ($course->faqs as $key => $faq)
                                                    <div class="accordion-item">
                                                        <input type="radio" name="accordion"
                                                            {{ $key == 0 ? 'checked' : '' }}
                                                            id="faq-{{ $faq->id }}" class="accordion-checkbox">
                                                        <label for="faq-{{ $faq->id }}"
                                                            class="cr-course-item accordion-header">
                                                            ...
                                                            <span class="accordion-icon">
                                                                <svg width="18" height="18"
                                                                    ...
                                                                    <path d="M4.5 6.75L9 11.25L13.5 6.75"
                                                                        stroke="#585858" stroke-linecap="round"
                                                                        stroke-linejoin="round" />
                                                                </svg>
                                                            </span>
                                                        </label>
                            ...
                            @else
                                <div class="cr-norecord">
                                    <div class="cr-norecord_content">
                                        <figure><img src="{{ asset('modules/courses/images/cr-no-record.png') }}"
                                                alt="no record"></figure>
                        ...
                        @if (
                            \Nwidart\Modules\Facades\Module::has('forumwise') &&
                                ...
                                !empty($course->discussion_forum))
                            <div wire:ignore.self class="tab-pane fade"
                                x-bind:class="{ 'show active': activeTab === 'cr-discussion' }" id="cr-discussion"
                                role="tabpanel" aria-labelledby="cr-discussion-tab">
                        ...
                        @endif
                        <div wire:ignore.self class="tab-pane fade cr-noticeboard-tab"
                            x-bind:class="{ 'show active': activeTab === 'cr-noticeboard' }" id="cr-noticeboard"
                            role="tabpanel" aria-labelledby="cr-noticeboard-tab">
                                ...
                                @if ($course->noticeboards->count() > 0)
                                    ...
                                    @foreach ($course->noticeboards as $noticeboard)
                                        <div class="cr-noticeboard-item">
                                            <span
                                                class="cr-noticeboard_date">{{ $noticeboard?->created_at?->format('M d, Y') }}</span>
                                    ...
                                    <ul class="cr-includes-list">
                                        <li class="cr-includes-item">
                                            ...
                                            <div class="cr-includes-text">
                                                ...
                                                <span
                                                    class="cr-includes-label">{{ $course->sections_count > 1 ? __('courses::courses.topics') : __('courses::courses.topic') }}</span>
                                            </div>
                                        </li>
                                        <li class="cr-includes-item">
                                            ...
                                            <div class="cr-includes-text">
                                                <span
                                                    class="cr-includes-value">{{ $course->curriculums_count }}</span>
                                                <span
                                                    class="cr-includes-label">{{ $course->curriculums_count > 1 ? __('courses::courses.lessons') : __('courses::courses.lesson') }}</span>
                                            </div>
                                        </li>
                                        @if (!empty($totalArticles))
                                            <li class="cr-includes-item">
                                                ...
                                                <div class="cr-includes-text">
                                                    <span
                                                        class="cr-includes-value">{{ number_format($totalArticles) }}</span>
                                                    <span
                                                        class="cr-includes-label">{{ $totalArticles == 1 ? __('courses::courses.article') : __('courses::courses.articles') }}</span>
                                                </div>
                                            </li>
                                        @endif
                                        @if (!empty($totalVideos))
                                            <li class="cr-includes-item">
                                                ...
                                                <div class="cr-includes-text">
                                                    @php
                                                        $total_duration = $course->curriculums
                                                            ->where('type', 'video')
                                                            ->sum('content_length');
                                                    @endphp
                                                    <span
                                                        class="cr-includes-value">{{ number_format($totalVideos) }}</span>
                                                    <span
                                                        class="cr-includes-label">{{ $totalVideos == 1 ? __('courses::courses.video') : __('courses::courses.videos') }}
                                                        of {{ getCourseDuration($total_duration) }}</span>
                                                </div>
                                            </li>
                                        @endif
                                    </ul>
                                    ...
                                    @if (empty($studentRating))
                                        <div class="cr-course-includes cr-course-rating-wrap">
                                            ...
                                            <div class="cr-rating-form" x-data="{ show: false, description: @entangle('description') }">
                                                ...
                                                <template x-if=" description?.length > 0">
                                                    <div class="cr-character-count-wrapper">
                                                        <span class="cr-character-count"
                                                            x-text="1000 - description.length"></span>
                                            ...
                                            <div class="cr-rating-btn-wrapper">
                                                <button class="am-btn cr-rating-btn" wire:click.prevent="submitRating"
                                                    wire:loading.attr="disabled"
                                                    wire:loading.class="am-btn_disabled">{{ __('courses::courses.submit') }}</button>
                                            </div>
                                        </div>
                                    @else
                                        <div class="cr-course-includes cr-course-rating-wrap">
                                            ...
                                            <div x-data="{ rating: {{ $studentRating->rating }} }" class="cr-rating-container">
                                                <span
                                                    ...
                                                    class="cr-stars">
                                                    @for ($i = 1; $i <= 5; $i++)
                                                        <i class="am-icon-star-01" id="rating-{{ $i }}"
                                                            x-on:click="rating = {{ $i }}"
                                                            x-bind:class="{ 'active': rating >= {{ $i }} }"></i>
                                                    @endfor
                                                </span>
                        ...
                        @if (!empty($course->instructor))
                            <div class="am-similar-user">
                                <div class="am-tutordetail_user"
                                    onclick="window.open(`{{ route('tutor-detail', ['slug' => $course->instructor?->profile?->slug]) }}`, '_blank')">
                                    @if (!empty($course->instructor->profile?->image))
                                        <figure class="am-tutorvone_img">
                                            <img src="{{ url(Storage::url($course->instructor->profile?->image)) }}"
                                                alt="{{ $course->instructor->profile?->short_name }}">
                                        </figure>
                                    @endif
                                    <div class="am-tutordetail_user_name">
                                        <h3>
                                            @if (!empty($course->instructor->profile?->full_name))
                                                <a
                                                    href="javascript:void(0);">{{ $course->instructor->profile?->full_name }}</a>
                                            @endif
                                            ...
                                            @if (!empty($course->instructor?->address?->country?->short_code))
                                                <span
                                                    class="flag flag-{{ strtolower($course->instructor?->address?->country?->short_code) }}"></span>
                                            @endif
                                        </h3>
                                        <span>{{ $course->instructor?->profile?->tagline }}</span>
                                    </div>
                                    ...
                                    @if (!empty($instructorAvgReviews) && !empty($instructorReviewsCount))
                                        <li>
                                            <div class="am-tutorreview-item">
                                                ...
                                                <span
                                                    class="am-uniqespace">{{ number_format($instructorAvgReviews, 1) }}
                                                    <em>/5.0
                                                        ({{ $instructorReviewsCount . ' ' . ($instructorReviewsCount > 1 ? __('courses::courses.reviews') : __('courses::courses.review')) }}
                                                        )</em></span>
                                            </div>
                                        </li>
                                    @endif
                                        ...
                                        <div class="am-tutorreview-item">
                                            <div class="am-tutorreview-item_icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                    ...
                                                    <g opacity="0.7">
                                                        <path
                                                            d="M9 16.5C13.1421 16.5 16.5 13.1421 16.5 9C16.5 4.85786 13.1421 1.5 9 1.5C4.85786 1.5 1.5 4.85786 1.5 9C1.5 13.1421 4.85786 16.5 9 16.5ZM7.18201 7.23984C7.18201 6.4545 8.04578 5.97564 8.71184 6.39173L11.5295 8.15195C12.1564 8.54359 12.1564 9.45654 11.5295 9.84817L8.71184 11.6084C8.04578 12.0245 7.18201 11.5456 7.18201 10.7603V7.23984Z"
                                                            stroke="#585858" stroke-width="1.5"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </g>
                                                </svg>
                                            </div>
                                            <span> {{ number_format($this->instructorCoursesCount) }}
                                                <em>{{ $this->instructorCoursesCount == 1 ? __('courses::courses.course') : __('courses::courses.courses') }}</em></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="am-tutorreview-item">
                                                ...
                                                <div class="wa-tags-list">
                                                    <ul x-data="{ open: false }">
                                                        ...
                                                        @foreach ($course->instructor->languages as $index => $language)
                                                            ...
                                                            @else
                                                                <li x-show="open">
                                                                    <span>{{ ucfirst($language->name) }}</span></li>
                                                            @endif
                                                        @endforeach
                                                        ...
                                                        @if ($course->instructor->languages->count() > 2)
                                                            <li>
                                                                <a href="javascript:void(0);" @click="open = !open">
                                                                    <span x-show="!open">
                                                                        +{{ $course->instructor->languages->count() - 2 }}
                                                                        {{ __('courses::courses.more') }}
                                                                    </span>
                                                                    <span x-show="open">
                                ...
                                <div class="cr-profile-footer">
                                    @if (!empty($course->instructor?->socialProfiles) && $course->instructor?->socialProfiles->isNotEmpty())
                                        <ul class="cr-social-icons">
                                            @php
                                                $validProfiles = $course->instructor?->socialProfiles
                                    ...
                                    @endif
                                    <a
                                        href="{{ route('tutor-detail', ['slug' => $course->instructor?->profile->slug]) }}">
                                        <button
                                            class="cr-view-profile-btn">{{ __('courses::courses.view_profile') }}</button>
                                    </a>
                                </div>
                            </div>
                        @endif
    ...
    <div class="cr-sharemodal modal fade" id="cr-sharemodal" tabindex="-1" aria-labelledby="shareModalLabel"
                ...
                <div class="am-modal-body">
                    <div class="am-share-link" x-data="{ copied: false, textToCopy: '{{ route('courses.course-detail', ['slug' => $course->slug]) }}' }">
                        ...
                        <div class="cr-copy-link">
                            <input type="text" disabled class="form-control" readonly
                                value="{{ route('courses.course-detail', ['slug' => $course->slug]) }}">
                            <button
                                @click="navigator.clipboard.writeText(textToCopy).then(() => { copied = true; setTimeout(() => copied = false, 1000) }).catch(() => {})"
                                class="cr-btncopy">
                                <i class="am-icon-copy-01"></i>
                                <template x-if="copied">
                                    <span class="am-tooltip-text" x-bind:class="{ 'am-tooltip-text-enable': copied }"
                                        x-show="copied" x-transition>{{ __('general.copied') }}</span>
                                </template>
                            </button>
                        </div>
                    </div>
                    <div class="cr-share-icons">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}"
                            target="_blank" class="cr-facebook">
                        ...
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}&text={{ urlencode($course->title) }}"
                            target="_blank" class="cr-twitter">
                            <img src="{{ asset('modules/courses/images/icons-images/twitter.png') }}"
                                alt="twitter">
                        ...
                        <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode(route('courses.course-detail', ['slug' => $course->slug])) }}&title={{ urlencode($course->title) }}"
                            target="_blank" class="cr-linkedin">
                            <img src="{{ asset('modules/courses/images/icons-images/linkedin.png') }}"
                                alt="LinkedIn">
                        ...
                        <a href="https://wa.me/?text={{ urlencode($course->title . ' ' . route('courses.course-detail', ['slug' => $course->slug])) }}"
                            target="_blank" class="cr-instagaram">
                            <img src="{{ asset('modules/courses/images/icons-images/insta.png') }}"
                                alt="instagaram">
    ...
    @if (isActiveModule('quiz'))
        <div class="modal fade am-complete-popup am-successfully-popup" id="course_completed_popup"
                ...
                <div class="modal-content">
                    <div class="am-modal-body">
                        ...
                        <div class="am-successfully_title">
                            ...
                            <a href="{{ route('quiz.student.quizzes') }}"
                                class="am-btn">{{ __('courses::courses.view_quizzes') }}</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('styles')
    ...
    @vite(['public/css/videojs.css', 'public/css/flags.css'])
@endpush
